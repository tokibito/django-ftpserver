...
class SignalEmitterMixin:
    ...
    def on_login(self, username):
        ...
        logger.debug(
            "FTP login: username=%s, remote_ip=%s",
            username, self.remote_ip
        )
    ...
    def on_login_failed(self, username, password):
        ...
        logger.debug(
            "FTP login failed: username=%s, remote_ip=%s",
            username, self.remote_ip
        )
    ...
    def on_logout(self, username):
        ...
        logger.debug(
            "FTP logout: username=%s, remote_ip=%s",
            username, self.remote_ip
        )
    ...
    def on_file_received(self, file):
        ...
        logger.debug(
            ...
            self.username, file, self.remote_ip
        )
    ...
    def ftp_DELE(self, path):
        ...
        logger.debug(
            ...
            self.username, ftp_path, self.remote_ip
        )
    ...
    def ftp_RNTO(self, path):
        ...
        logger.debug(
            "FTP file renamed: username=%s, path_from=%s, path_to=%s, "
            "remote_ip=%s",
            self.username, path_from, path_to, self.remote_ip
        )
